...
class Quan(models.Model):
    maquan = models.CharField(max_length=10, primary_key=True)
    tenquan = models.CharField(max_length=20)
    def __str__(self):
        return self.tenquan
...
class LoaiDL(models.Model):
    maloaidaily = models.CharField(max_length=10, primary_key=True)
    tenloaidaily = models.CharField(max_length=10)
    def __str__(self):
...
class DonViTinh(models.Model):
    madonvitinh = models.CharField(max_length=10, primary_key=True)
    tendonvitinh = models.CharField(max_length=10)
    def __str__(self):
...
class MatHang(models.Model):
        mamathang = models.CharField(max_length=5, primary_key=True)
        tenmathang = models.CharField(max_length=10)
        gia=models.CharField(max_length=10000)
...
class HoSoDL(models.Model):
    tendaily = models.CharField(max_length=10)
    mahosodaily = models.CharField(max_length=10,primary_key=True)
    #phieuxuathang=models.CharField(max_length=100)
    dienthoai = models.CharField(max_length=12)
    diachi = models.CharField(max_length=20)
    ...
    tienno=models.PositiveIntegerField(max_length=100, default=0)
...
class PhieuXuatHang(models.Model):
    maphieuxuathang=models.CharField(max_length=10,primary_key=True)
    ...
    tongtien=models.CharField(max_length=100000)
    sotientra=models.CharField(max_length=100000)
...
class CTPhieuXuatHang(models.Model):
    machitietphieuxuathang=models.CharField(max_length=10,primary_key=True)
    ...
    dongia=models.CharField(max_length=100000)
    thanhtien=models.CharField(max_length=100000)
    maphieuxuathang=models.ForeignKey(PhieuXuatHang,on_delete=models.CASCADE)
    active3 = models.BooleanField(default=True)
    def __str__(self):
